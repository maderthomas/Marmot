...
namespace MarmotLibrary {
  ...
  /**
   * @brief Factory class for creating MarmotMaterialGradientPlasticityHypoElasticinstances.
   * This class uses the Factory Design Pattern to manage the creation of different
   * MarmotMaterialGradientPlasticityHypoElastic materials based on unique material names.
   */
  ...
  public:
    ...
    /// MarmotMaterialGradientPlasticityHypoElastic.
    using materialFactoryFunction = std::function< MarmotMaterialGradientPlasticityHypoElastic<
     ...
     */
    static MarmotMaterialGradientPlasticityHypoElastic< nYieldSurfaces >* createMaterial(
    ...
    static bool registerMaterial( const std::string& materialName )
    {
      ...
      map[materialName] = []( const double* materialProperties,
                              int           nMaterialProperties,
                              int materialNumber ) -> MarmotMaterialGradientPlasticityHypoElastic< nYieldSurfaces >* {
